...
kernel/ata.o: kernel/ata.c
 gcc -m32 -ffreestanding -fno-builtin -nostdlib -c kernel/ata.c -o kernel/ata.o

kernel/fat12.o: kernel/fat12.c
 gcc -m32 -ffreestanding -fno-builtin -nostdlib -c kernel/fat12.c -o kernel/fat12.o

kernel/kernel.bin: kernel/entry.o kernel/keyboard_isr.o kernel/kernel.o \
